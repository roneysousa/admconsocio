            ...
            begin
                 ...
                 begin
                     dmAdmDados.Incluir_Parcela_Boleto_avulso(
                      ...
                      //
                      aDescricao := 'Inc.Boleto Avulso G : '+edtGrupo.Text + ' | C '+ edtCota.Text + ' | V '+edtVenda.Text
                            + ' | Venc.:' + FieldByname('PAR_VENCIMENTO').AsString +' | Valor:'+FormatFloat('###,##0.#0',edtValor.Value);
