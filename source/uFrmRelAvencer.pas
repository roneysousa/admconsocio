         ...
         if not (dmRelatorios.cdsClientesAtraso.IsEmpty) Then
          begin
            ...
            begin
                 ...
                 //
                 lblTitulo.Caption := lblTitulo.Caption + edtDTINIC.Text + ' à '+edtDTFINA.Text ;
                 //
                 If (aSituacao = 'A') Then
                     lblCotas.Caption  := 'Situação : ATIVAS  - Cotas do Grupo : ' + aDescricao;
                 If (aSituacao = 'I') Then
                     lblCotas.Caption  := 'Situação : INATIVAS  - Cotas do Grupo : ' + aDescricao;
                 If (iGrupo > 0) Then
