...
uses udmAdmDados, uFuncoes, uFrmCadUsuario;
     ...
     try
          With cdsPermissoes do
                 ...
                 While not (Eof) do
                  begin
                       ...
                       Else
                           aExcluir := 'N';
                       //
                       dmAdmDados.Incluir_Acesso_Usuario(M_CDUSUA, cdsPermissoesCODIGO.AsInteger,
            ...
            If (cbxAdmin.Checked) Then
                dmAdmDados.SetAdminUsuario(M_CDUSUA, 'T')
            Else
                dmAdmDados.SetAdminUsuario(M_CDUSUA, 'F');
            //
...
begin
     If not (dmAdmDados.ValidarAcesso(StrtoInt(DBText2.Caption))) Then
     begin
         dmAdmDados.Acessos_Sistema(cdsPermissoes, 1, 0);
     ...
     Else}
     dmAdmDados.Acessos_Sistema(cdsPermissoes, 2, StrtoInt(DBText2.Caption));
     //
          ...
          With cdsPermissoes do
            begin
                 ...
                 While not (Eof) do
                  begin
                       //
                       dmAdmDados.Incluir_Acesso_Usuario(aUsuario, cdsPermissoesCODIGO.AsInteger,
                              cdsPermissoesMENU_NOME.AsString,
                              'N', 'N', 'N', 'N');
                       //
                       Next;
