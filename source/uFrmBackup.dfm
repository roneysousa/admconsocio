object frmBackup: TfrmBackup
  ...
  object DMBanco: TIBDatabase
    DatabaseName = 'C:\Infog2\AdmConsocio\CONSOCIO.FDB'
    Params.Strings = (
      'user_name=SYSDBA'
      'password=masterkey'
      'lc_ctype=WIN1252')
  ...
  object dstListaAcao: TSQLDataSet
    CommandText = 
      'Select * from TAREFAS_USUARIOS TU WHERE TU.tar_acao Like '#39'Inativ' +
      'ou (Pago)%'#39
    MaxBlobSize = -1
    Params = <>
  ...
  object dspLista: TDataSetProvider
    DataSet = dstListaAcao
    Options = [poAllowCommandText]
    Left = 96
    Top = 128
  end
  object cdsListaAcao: TClientDataSet
    Aggregates = <>
    CommandText = 
      'Select * from TAREFAS_USUARIOS TU WHERE TU.tar_acao Like '#39'Inativ' +
      'ou (Pago)%'#39
    ...
    Left = 152
    Top = 128
    object cdsListaAcaoTAR_SEQUENCIA: TIntegerField
      FieldName = 'TAR_SEQUENCIA'
      Required = True
    end
    object cdsListaAcaoTAR_USUARIO: TIntegerField
      FieldName = 'TAR_USUARIO'
    end
    object cdsListaAcaoTAR_DTMOVI: TDateField
      FieldName = 'TAR_DTMOVI'
    end
    object cdsListaAcaoTAR_ACAO: TStringField
      FieldName = 'TAR_ACAO'
      Size = 120
    end
  end
