object frmTarefaUsuarios: TfrmTarefaUsuarios
  ...
  object Panel3: TPanel
    ...
    object edtDataLoc: TDateEdit
      ...
      NumGlyphs = 2
      TabOrder = 1
      OnChange = edtDataLocChange
      OnKeyPress = edtDataLocKeyPress
    end
  end
  ...
  object datasetConsultar: TSQLDataSet
    CommandText = 
      'Select TU.tar_usuario, TU.tar_dtmovi, tu.tar_acao from TAREFAS_U' +
      'SUARIOS TU Where (TU.TAR_USUARIO = :pUSUARIO) and (TU.tar_dtmovi' +
      ' = :pdtmovi)'
    MaxBlobSize = -1
    Params = <
      item
